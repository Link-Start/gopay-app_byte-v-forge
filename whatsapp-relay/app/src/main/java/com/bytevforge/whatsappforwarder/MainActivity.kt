...
private fun WhatsAppForwarderScreen() {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                "Forward WhatsApp OTP notifications to the channel OTP webhook.",
            ...
            SectionCard {
                OutlinedTextField(
                    ...
                    placeholder = { Text("http://webhook.byte-v-forge.192.168.0.126.nip.io:30080/gopay-account-id/gopay") },
                    singleLine = true,
