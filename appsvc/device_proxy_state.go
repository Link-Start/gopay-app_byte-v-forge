...
func (s *Server) generateDeviceProxyStateWithLeaseTTL(ctx context.Context, accountID string, countryCode string, forceNew bool, skipPreflight bool, ephemeralProfile bool, leaseTTLOverride string) (stateMap, error) {
	return s.generateDeviceProxyStateWithOptions(ctx, accountID, countryCode, forceNew, skipPreflight, ephemeralProfile, leaseTTLOverride)
}

func (s *Server) generateDeviceProxyStateWithOptions(ctx context.Context, accountID string, countryCode string, forceNew bool, skipPreflight bool, ephemeralProfile bool, leaseTTLOverride string) (stateMap, error) {
